...
import SakaiFloatingConfigurator from './SakaiFloatingConfigurator.vue'
          ...
          <div class="mb-4 flex flex-col space-y-4">
            ...
            <div class="mb-8 mt-2 flex items-center justify-between gap-8">
              <div class="flex items-center">
                <!-- <PrimeCheckbox v-model="checked" input-id="rememberme1" binary class="mr-2" /> -->
            ...
            <PrimeButton :label="stepInfos[step].buttonText" class="w-full" @click="stepInfos[step].buttonAction()" />
          </div>
        </div>
      </div>
    </div>
