...
import { definePreset as defineUnocssPreset } from 'unocss'
...
/**
 * unocss preset for PrimeVue Sakai theme
 * @see https://unocss.dev/config/presets
 */
export function primevueSakaiPresetOfUnocss() {
  return defineUnocssPreset(() => ({
    name: 'primevue-sakai',
    layer: 'primevue-sakai',
    theme: {
      /**
       * tailwindcss-primeui
